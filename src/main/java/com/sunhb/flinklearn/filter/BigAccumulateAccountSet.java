 ...
 */
public class BigAccumulateAccountSet {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Tuple3<Long,Long,Double>> idFilterStream = dataSource.map(line -> {
            ...
            String id = fields[1];
            String orderAmount = fields[4];

            return new Tuple3<Long,Long,Double>(Long.parseLong(id), Long.parseLong(orderId),Double.parseDouble(orderAmount));
